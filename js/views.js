(function() {
  ...
  views["item"] = "<li class=\"item\"><span class=\"corner\"></span>{{title}}</li>";

  views["joined"] = "<li id=\"joined\" class=\"prominent\"><div class=\"well span2 offset3\">Joined: {{user.created_at_string}}</div></li>";
